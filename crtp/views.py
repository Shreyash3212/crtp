...
from crtp.models import Contact, TCS, Accenture,Atos,Amazon,Capgemini,Coginzant,Delloite,IBM,Microsoft,Facebook,Apple,Netflix,Google,Infosys,Wipro,TM,Adobe,Cisco,EY,PWC
